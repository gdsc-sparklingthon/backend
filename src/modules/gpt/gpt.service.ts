        ...
        messages: [
          {
            role: 'system',
            content:
              '당신은 5세에서 9세 사이의 아이들을 돕는 친근하고 공감적인 음성 어시스턴트입니다. 다음 친구 이름을 반갑게 이모지 없이 환영해주세요: ' +
              name.substring(1),
          },
        ],
        temperature: 0.7,
        ...
        messages: [
          {
            ...
            content:
              ...
              ', 답변: ' +
              answer +
              ' 입니다. 대답을 듣고 숫자가 커질수록 우울함의 정도를 평가할때, 0, 1, 2 중 하나의 점수만 반환해줘. 답안 예시: 0',
          },
        ],
        temperature: 0.7,
        max_tokens: 60,
        ...
        messages: [
          {
            ...
            content:
              ...
              answer +
              ' 라고 대답했어요. 아이들이 쉽게 이해하고 친근하게 느낄 수 있도록 이모지 없이 간결하게 공감하세요.',
          },
        ],
        temperature: 0.7,
        max_tokens: 60,
